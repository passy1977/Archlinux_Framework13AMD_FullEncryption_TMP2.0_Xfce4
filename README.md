...
- [Boot by usb stick](#boot-by-usb-stick)
	...
	- [Populate fstab](populate-fstab)
	- [Copy header of encrypted partitions](copy-header-of-encrypted-partitions)
	- [Chroot to new system](chroot-to-new-system)
		- [Set localtime](set-localtime)
		- [Set the RTC from the system time](set-the-rtc-from-the-system-time)
		- [Uncomment desired locales](uncomment-desired-locales)
		- [Generate the locales](generate-the-locales)
		- [Set terminal keyboard map](set-terminal-keyboard-map)
		...
		- [Config systemd-boot loader](config-systemd-boot-loader)
		- [Config systemd-boot deafult entry](config-systemd-boot-deafult-entry)
		- [Config systemd-boot fallback entry](config-systemd-boot-fallback-entry)
		- [Set root passwd](set-root-passwd)
		- [Reboot system](reboot-system)
- [Boot from internal NVMe](boot-from-internal-nvme)
	- [Force keyboard mapp](Force-keyboard-mapp)
	- [Update the date by ntp protocol at system boot](update-the-date-by-ntp-protocol-at-system-boot)
	- [Add user](add-user)
	- [Install base services](install-base-services)
	- [Configure base services](configure-base-services)
	- [Enable swap](enable-swap)
	- [Set tpm2](set-tpm2)
	- [Enable Timeshift](enable-timeshift)
	- [Set suspension on low battery](set-suspension-on-low-battery)
	- [Install XFCE4](install-xfce4)
	- [Install Bluez](install-bluez)
	- [Install Cups](install-cups)
	- [Update finger reader device](update-finger-reader-device)
	- [Update login with fingerprint](update-login-with-fingerprint)
	- [Add developer base tools](add-developer-base-tools)

## Hardware

* **Framework 13  E15G2** (20T8001UTX)
